          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-lg">
                <i className="fas fa-yarn-ball text-white text-lg">🧶</i>
              </div>
              <div>
                <h1 className="text-xl font-bold text-gray-800">Каталог пряжи</h1>
                <p className="text-xs text-gray-500">
                  {items.length} наименований • {totalQuantity} мотков
                </p>
              </div>
            </div>
            <button
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Поиск по названию, артикулу, составу, цвету..."
...
function App() {
  ...
  // Подсчёт общего веса всей пряжи
